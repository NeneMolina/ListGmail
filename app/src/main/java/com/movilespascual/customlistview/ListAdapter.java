...
public class ListAdapter extends BaseAdapter {
    ...
    Context contexto;
    String [] nombres, mensajes,asuntos,horaUltimoMensaje,numeroTelefono,pais;
    int[] idImagen;
    LayoutInflater inflater;

    public ListAdapter(Context contexto, String[] nombres, String[] mensajes,String[] asuntos,
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        TextView ultimoAsunto = view.findViewById(R.id.ultimoAsunto);
        ...
        ultimoAsunto.setText(asuntos[i]);
